...
CREATE table producto (
    ...
    foreign key (marca_id) references modelo (marca_id) ON DELETE CASCADE,
...
CREATE table venta (
    ...
    foreign key (producto_id) references cliente (producto_id) ON DELETE CASCADE
    );
CREATE table devolucion (
    ...
    foreign key (producto_id) references cliente (producto_id) ON DELETE SET NULL,
    foreign key (cliente_id) references cliente (cliente_id) ON DELETE SET NULL
    );
